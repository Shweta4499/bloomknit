...
import sunflower from "../assets/sunflower.webp"; // ✅ Use optimized webp
...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* 🌻 Optimized Background-Image Flowers */}
      {positions.map((pos, index) => (
        <motion.div
          key={index}
          className={`absolute ${sizes[index] || "w-40"} aspect-square opacity-20 pointer-events-none bg-contain bg-no-repeat`}
          style={{
